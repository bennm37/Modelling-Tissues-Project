...
def plot_potential(potential,parameters,ax=None):
    ...
    for i,x in enumerate(X):
        ...
        k,epsilon,l = parameters
        data[i] = potential(pvec,R,k,epsilon,l)[0,0]
    if not ax:
        fig,ax = plt.subplots()
...
parameter_potential_plot(parabola_potential,["k","epsilon","l"],slider_init=[1,0.15,-1],slider_ranges=[(0,3),(0,1),(-5,0)])